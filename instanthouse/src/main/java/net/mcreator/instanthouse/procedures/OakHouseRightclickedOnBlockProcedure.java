...
public class OakHouseRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof ServerLevel _serverworld) {
			StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("instanthouse", "house1"));
			if (template != null) {
		...
		if (entity instanceof Player _player) {
			ItemStack _stktoremove = new ItemStack(InstanthouseModItems.OAK_HOUSE.get());
